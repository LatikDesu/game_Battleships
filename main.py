...
class BoardOutException(BoardException):
    def __str__(self):
        return "Торпеда улетела за пределы игрового поля"


class BoardUsedException(BoardException):
    def __str__(self):
        return "Торпеда сюда уже стреляла"
...
class Ship:
    def __init__(self, head, ship_len, orientation):
        self.head = head
...
class AI(Player):
    def ask(self):
        ...
        print(f"Вражеский удар: {d.x+1} {d.y+1}")
        return d
